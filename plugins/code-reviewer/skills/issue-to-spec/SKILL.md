...
**Fallback**: If `/interview` is not available (skill invocation fails or the user does not have `kainoaseto-core` installed), conduct the interview yourself using `AskUserQuestion` directly. Follow this process:
